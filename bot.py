...
‼️ВАЖНО‼️ Сделав заказ, вы автоматически соглашаетесь с правилами:
...
Если ты не с форума - то просто напиши " — "."""
...
Если вы не знаете какую назвать цену - ставьте " — ". В этом случае мы сами вам её сообщим."""
